    ...
    public class when_creating_a_user_profile : given_a_user_profile_controller_context
    {
        ...
        Establish context =
            () => _mockUserProfileService
                      .Setup(x => x.CreateUserProfile(Parameter.IsAny<UserProfile>()))
        ...
        It should_use_the_service_to_create_the_user_profile = () => _mockUserProfileService.Verify(x => x.CreateUserProfile(Parameter.IsAny<UserProfile>()));
